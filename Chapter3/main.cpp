...
class OpenXRTutorial {
	...
	private:
		...
		void GetSystemID() {
			...
			std::cout << "System ID: " << m_systemID << std::endl;
			std::cout << "System Name: " << m_systemProperties.systemName << std::endl;
			std::cout << "Vendor ID: " << m_systemProperties.vendorId << std::endl;
		}
        void CreateSession() {
